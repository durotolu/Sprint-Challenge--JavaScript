...
console.log(tsaurus.weight);

// What was the diet of a velociraptor?
console.log(vraptor.diet);

// How long was a stegosaurus?
console.log(ssaurus.length);

// What time period did tyrannosaurus live in?
console.log(tsaurus.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
tsaurus.roar = function () {
  return "RAWERSRARARWERSARARARRRR!";
}

console.log(tsaurus.roar());
...
const lowerCase = zooAnimals.map(element.animal_name.toLowerCase());
...
*/
const populationTotal = zooAnimals.reduce((acc, element) => element.population + acc, 0);
